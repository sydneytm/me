    ...
    <ThemeProvider theme={theme}>
      <ParallaxLayer>
        ...
        <Typography color="primary.main" style={{ marginBottom: "50px" }}>
          The Dihedral group of order 6 (D3) is a useful group in abstract
          algebra describing the symmetries of a triangle, with each of its
          ...
          create new operations. D3 is also non-abelian (non-commutative) and
          the smallest non-abelian group in group theory.{" "}
        </Typography>
      </ParallaxLayer>
